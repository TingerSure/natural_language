...
var (
	SetFieldObjectErrorException = interrupt.NewException("type error", "TODO")
	SetFieldKeyErrorException    = interrupt.NewException("type error", "TODO")
	SetFieldKeyNotExistException = interrupt.NewException("type error", "TODO")
)
