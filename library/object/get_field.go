...
var (
	GetFieldObjectErrorException = interrupt.NewException("type error", "TODO")
	GetFieldKeyErrorException    = interrupt.NewException("type error", "TODO")
	GetFieldKeyNotExistException = interrupt.NewException("type error", "TODO")
)
