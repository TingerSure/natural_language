...
type KeyKeyIndexSeed interface {
	ToLanguage(string, *KeyKeyIndex) string
	Type() string
...
func (f *KeyKeyIndex) ToLanguage(language string) string {
...
type KeyKeyIndexCreator struct {
	Seeds map[string]func(string, *KeyKeyIndex) string
...
func (s *KeyKeyIndexCreator) ToLanguage(language string, instance *KeyKeyIndex) string {
